...
namespace VisionProgram
{
    ...
    public class MasterK200_1
    {
        ...
        public void MasterK_Read_B(string address)    //  바이트로 읽기때문에 번지 address x2 해야함  16진수형식으로 EX ) 4000번지 ㅡ> (*2해서) 38 30 30 30 
        {
            ...
            Send("4C5349532D5847540000 0000 B033 0000 1300 0152 5400 1400 0000 0100 0700 25 44 42" + address + "3C00");//DB4000 부터 30개워드 연속읽기                                                                                                                       //44C5349532D5847540000 0000 B033 0000 1300 0152 5400 1400 0000 0100 0700 25 44 42    34303030   3C00
